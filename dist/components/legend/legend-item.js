...
var LegendItem = function LegendItem(_ref14) {
  ...
  var min = legendItemProps.min,
      ...
      symbolProps = _objectWithoutProperties(legendItemProps, ["min", "max", "type", "legendSize", "symbolMarginLeft", "setSymbolMarginLeft", "rightTextOffset", "setRightTextOffset", "paddingLeft", "setOpacity"]);
  ...
  var _getLegendItemDimensi = (0, _utils.getLegendItemDimensions)({
    ...
    legendSize: legendSize
      ...
      textContainerLeftMargin = _getLegendItemDimensi.textContainerLeftMargin; // set symbolMarginLeft as the maxium left margin value of all legend item symbols
  ...
  }, [symbolContainerLeftMargin, setSymbolMarginLeft, type]); // sets the maximum width of the upper data range text in all legends, except for line width legend
  ...
  }, [type, textMaxWidth, setRightTextOffset, legendElemWidth, legendSize, symbolProps.size]); // adjust LegendElement left margin so the legend symbols of all legends align vertically
  ...
  var legendElementsLeftMargin = (0, _react.useMemo)(function () {
    ...
    return 0;
  }, [symbolMarginLeft, symbolContainerLeftMargin]); // reveal Legend only after the textContainerWidth has been calculated
