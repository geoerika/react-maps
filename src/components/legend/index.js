...
const Legend = ({ position, legends, metricAliases, truncateLegendTitle, formatData, typography }) => {
  let objPosition = {}
    ...
    <>
      ...
      >
        {legends.map(({ type, ...legendProps }) => (
          <LegendItem
            key={type}
            legendItemProps={{ type, metricAliases, truncateLegendTitle, formatData, ...legendProps }}
          />
        ))}
      </LegendContainer>
    </>
